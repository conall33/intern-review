...
public class HeaderBarContacts extends RelativeLayout implements View.OnClickListener {
	...
	public HeaderBarContacts(Context context) {
		super(context);
        init(context);
    }

	public HeaderBarContacts(Context context, AttributeSet attrs) {
		super(context, attrs);
        init(context);
        setAttributeSet(context, attrs);
	}

	public HeaderBarContacts(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private void init(Context context) {
		mContext = context;
		mRootView = LayoutInflater.from(mContext).inflate(R.layout.headerbar_contacts, this, false);
		addView(mRootView);
